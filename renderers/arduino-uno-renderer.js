...
(function (global) {
  ...
  function _buildBoard(g) {
    ...
    app(g, mk('rect',   { x: '192', y: '155', width: '26', height: '42', rx: '9', fill: 'url(#unoSilvGr)', stroke: '#888', 'stroke-width': '1.5' }));
    app(g, mk('rect',   { x: '196', y: '163', width: '18', height: '28', rx: '5', fill: '#c0c0c0' }));
