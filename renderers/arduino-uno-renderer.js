...
// AMS1117-5V Voltage Regulator - Wide & Low Profile with Centered Legs
    ...
    // ICSP header
    app(g, mk('rect', { x: '180', y: '410', width: '54', height: '34', rx: '2', fill: '#0d0d0d', stroke: '#333', 'stroke-width': '1.2' }));
    ...
    // Main ICSP box
    app(icspGroup, mk('rect', { x: icspX, y: icspY, width: '54', height: '34', rx: '2', fill: '#0d0d0d', stroke: '#333', 'stroke-width': '1.2' }));
    // Inner boxes
    [[icspX+6, icspY+6],
    [icspX+22, icspY+6],
    [icspX+38, icspY+6],
