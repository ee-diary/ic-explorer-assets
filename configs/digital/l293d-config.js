window.IC_CONFIG = {
  ...
  pins: [
    ...
    },
    {
      ...
      id:    'VCC2',
      lbl:   'VCC2',
      name:  'Motor Supply Voltage (VCC2 / VS)',
      type:  'PWR',
      funcs: ['PWR'],
      volt:  '4.5–36V',
      curr:  'N/A',
    ...
    // ── RIGHT SIDE (pins 9–16, top-right → bottom-right) ────────
    {
      num:   9,
      id:    'EN3',
      lbl:   'EN3,4',
  ...
  quickSpecs: [
    ...
    { label: 'Motor VCC',   value: '4.5 – 36V',         color: '#78c878' },
    { label: 'Logic VCC',   value: '4.5 – 7V',          color: '#78c878' },
    { label: 'Cont. Current', value: '600 mA / channel', color: '#c8a850' },
    { label: 'Peak Current', value: '1.2 A / channel',  color: '#ff6b6b' },
    { label: 'Logic',       value: 'TTL / CMOS',        color: '#e0e5ec' },
  ],
  ...
  dsSpecs: [
    ...
    { label: 'Motor Supply (VCC2)', value: '4.5 V – 36 V' },
    ...
    { label: 'Output Voltage Drop', value: '~1.8 V at 600 mA (built-in transistor drop)' },
