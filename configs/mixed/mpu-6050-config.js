...
window.IC_CONFIG = {
  ...
  pins: [
    { num: 1, id: 'CLKIN', lbl: 'CLKIN', name: 'External Clock Input', type: 'CLK', funcs: ['CLK'], volt: 'N/A', curr: 'N/A', note: 'Optional external clock input.' },
    { num: 2, id: 'CPOUT', lbl: 'CPOUT', name: 'Charge Pump Output', type: 'CPOUT', funcs: ['CPOUT'], volt: 'N/A', curr: 'N/A', note: 'Connect 10nF capacitor between CPOUT and CPGND.' },
    ...
    { num: 7, id: 'REGOUT', lbl: 'REGOUT', name: 'Regulator Output', type: 'PWR', funcs: ['PWR'], volt: 'N/A', curr: 'N/A', note: 'Connect 10nF capacitor to GND.' },
    { num: 8, id: 'VDD', lbl: 'VDD', name: 'Analog Supply', type: 'PWR', funcs: ['PWR'], volt: '2.375-3.46V', curr: 'N/A', note: 'Decouple with 0.1µF capacitor.' },
    { num: 9, id: 'GND', lbl: 'GND', name: 'Ground', type: 'GND', funcs: ['GND'], volt: '0V', curr: 'N/A', note: 'Connect to ground plane.' },
    { num: 10, id: 'GND', lbl: 'GND', name: 'Ground', type: 'GND', funcs: ['GND'], volt: '0V', curr: 'N/A', note: 'Connect to ground plane.' },
    { num: 11, id: 'VLOGIC', lbl: 'VLOGIC', name: 'Digital I/O Supply', type: 'PWR', funcs: ['PWR'], volt: '1.71-3.46V', curr: 'N/A', note: 'Must be ≤ VDD.' },
    { num: 12, id: 'AD0', lbl: 'AD0', name: 'I2C Address Select', type: 'I2C', funcs: ['I2C'], volt: '0-3.46V', curr: 'N/A', note: 'GND=0x68, VLOGIC=0x69.' },
    { num: 13, id: 'INT', lbl: 'INT', name: 'Interrupt', type: 'INT', funcs: ['INT'], volt: '0-3.46V', curr: 'N/A', note: 'Active-high open-drain interrupt.' },
    { num: 14, id: 'SDA', lbl: 'SDA', name: 'I2C Serial Data', type: 'I2C', funcs: ['I2C'], volt: '0-3.46V', curr: 'N/A', note: 'Requires pull-up resistor.' },
    { num: 15, id: 'SCL', lbl: 'SCL', name: 'I2C Serial Clock', type: 'I2C', funcs: ['I2C'], volt: '0-3.46V', curr: 'N/A', note: 'Requires pull-up resistor.' },
    { num: 16, id: 'AUX_DA', lbl: 'AUXDA', name: 'Auxiliary I2C Data', type: 'AUX', funcs: ['AUX'], volt: '0-3.46V', curr: 'N/A', note: 'For external magnetometer.' },
    { num: 17, id: 'AUX_CL', lbl: 'AUXCL', name: 'Auxiliary I2C Clock', type: 'AUX', funcs: ['AUX'], volt: '0-3.46V', curr: 'N/A', note: 'For external magnetometer.' },
    { num: 18, id: 'GND', lbl: 'GND', name: 'Ground', type: 'GND', funcs: ['GND'], volt: '0V', curr: 'N/A', note: 'Connect to ground plane.' },
    { num: 19, id: 'GND', lbl: 'GND', name: 'Ground', type: 'GND', funcs: ['GND'], volt: '0V', curr: 'N/A', note: 'Connect to ground plane.' },
    { num: 20, id: 'CPGND', lbl: 'CPGND', name: 'Charge Pump Ground', type: 'GND', funcs: ['GND'], volt: '0V', curr: 'N/A', note: 'Connect 10nF capacitor between CPOUT and CPGND.' },
  ...
  dsFeatures: [
    ...
    'Low power: 3.9mA active, 8uA sleep'
  ]
};
